            ...
            <div class="row row-lg">
                <div class="col-sm-12 col-md-12">
                    ...
                    <div class="example-wrap">
                        ...
                        <div class="example">
                        	{!! Form::model($po,['url'=>'purchase-order/update/'.$po->id,'method'=>'POST','class'=>'form-horizontal']) !!}
                              ...
                              <div class="form-group{{ $errors->has('ro_id') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text("ro_id",$po->no_ro,['class'=>'form-control','readonly'=>true]) !!}
                                        @if($errors->has('ro_id'))
                                ...
                                <div class="form-group" id="result">
                                  ...
                                  <div class="col-sm-9">
                                      <table class="table" id="subcat">
                                          ...
                                          <tbody>
                                              @foreach($po->ro->detail_ro as $dt)
                                              <tr>
                                                  <td width="60%">{!! Form::text('products[]',$dt->product->p_name,['class'=>'form-control','readonly'=>true]) !!}</td>
                                                  <td width="10%"><input type="number" class="form-control" name="qty_req[]" min="0" value="{{ $dt->qty_req }}" readonly></td>
                                                  <td width="10%"><input type="number" class="form-control" name="qty_approve[]" min="0" value="{{ $dt->qty_approve }}" readonly ></td>
