  ...
  <div class="panel">
        ...
        <div class="panel-body">
          <div class="example-wrap">
            ...
            <div class="example">
              {!! Form::open(['url'=>'report/request-order','method'=>'POST','class'=>'form-horizontal']) !!}
                ...
                <div class="form-group">
                  <label class="control-label" for="order">Status Request Order</label>
                  {!! Form::select('status_ro',['0'=>'On Process','1'=>'Accepted','2'=>'Rejected'],null,['placeholder'=>'Choose','class'=>'form-control','id'=>'order']) !!}    
