  ...
  <div class="panel">
        ...
        <div class="panel-body">
          <div class="example-wrap">
            ...
            <div class="example">
              {!! Form::open(['url'=>'report/purchase-order','method'=>'POST','class'=>'form-horizontal']) !!}
                <div class="form-group">
                  <label class="control-label" for="department">Department</label>
                    {!! Form::select('department_id',$department,old('department_id'),['placeholder'=>'Choose','class'=>'form-control','id'=>'department']) !!}             
                </div>
