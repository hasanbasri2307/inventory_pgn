                ...
                <tbody>
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td>{{ $product->sub_category->category->cat_name }}</td>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu animate" aria-labelledby="exampleAnimationDropdown1" role="menu">
                                  <li role="presentation"><a href="{{ url('product/edit/'.$product->id.'/'.strtolower(str_replace(" ", "-", $product->p_name))) }}" role="menuitem"><i class="icon wb-edit" aria-hidden="true"></i>Edit</a></li>
                                  <li role="presentation"><a href="{{ url('product/delete/'.$product->id) }}" role="menuitem" data-method="delete" data-confirm="Delete this data ?" data-token="{{ csrf_token() }}"><i class="icon wb-trash" aria-hidden="true" ></i>Delete</a></li>
